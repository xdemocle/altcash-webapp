/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2ec3fd07fa5f94c7587f34aca5fe9a85)
// Runtime types generated with workerd@1.20251011.0 2025-09-15 enable_nodejs_process_v2,global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_PAYSTACK_EMAIL: string;
		NEXT_PUBLIC_PAYSTACK_PUBLICK_KEY: string;
		NEXT_PUBLIC_GA_MEASUREMENT_ID: string;
		SENDGRID_API_KEY: string;
		CMC_PRO_API_KEY: string;
		BINANCE_API_KEY_TESTNET: string;
		BINANCE_API_SECRET_TESTNET: string;
		BINANCE_API_KEY: string;
		BINANCE_API_SECRET: string;
		CACHE_PURGE_ZONE_ID: string;
		CACHE_PURGE_API_TOKEN: string;
		WORKER_SELF_REFERENCE: Service<typeof import("./worker/app").default>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_GRAPHQL_SERVER" | "NEXT_PUBLIC_PAYSTACK_EMAIL" | "NEXT_PUBLIC_PAYSTACK_PUBLICK_KEY" | "NEXT_PUBLIC_GA_MEASUREMENT_ID" | "SENDGRID_API_KEY" | "CMC_PRO_API_KEY" | "BINANCE_API_KEY_TESTNET" | "BINANCE_API_SECRET_TESTNET" | "BINANCE_API_KEY" | "BINANCE_API_SECRET" | "CACHE_PURGE_ZONE_ID" | "CACHE_PURGE_API_TOKEN">> {}
}
